...
class ArucoDetector(Node):
    def __init__(self):
        ...
        # Create subscriber
        ####### ENTER CODE HERE #######
        self.listen_camera_subscriber = self.create_subscription(
            msg_type=Image,
            topic="/image_raw",
        ...
        self.marker_length=self.declare_parameter("marker_length",0.05)
        ###############################
    ...
    def detect_aruco(self, frame):
        ...
        if ids is not None:
            ...
            ####### ENTER CODE HERE #######
            t.transform.translation.x = self.filtered_tvec[0]
            t.transform.translation.y = self.filtered_tvec[1]
            t.transform.translation.z = self.filtered_tvec[2]

            t.transform.rotation.x = self.filtered_q[0]
            t.transform.rotation.y = self.filtered_q[1]
            t.transform.rotation.z = self.filtered_q[2]
            t.transform.rotation.w = self.filtered_q[3]
            ...
            ####### ENTER CODE HERE #######
            marker.pose.position.x = self.filtered_tvec[0]
            marker.pose.position.y = self.filtered_tvec[1]
            marker.pose.position.z = self.filtered_tvec[2]
